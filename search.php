        ...
        $pages = ceil($total / $perpage);
         ...
         ?>
           ...
           <div class="center-align animated slideInUp wow">
             ...
             <li class="<?php if($page == 1){echo 'hide';} ?>"><a href="?page=<?php echo $page-1; ?>&per-page=15&searched=<?php echo $word; ?>"><i class="material-icons">chevron_left</i></a></li>
             <?php for ($x=1; $x <= $pages; $x++) : $y = $x;?>


                 <li class="waves-effect pagina  <?php if($page === $x){echo 'active';} elseif($page <  ($x +1) OR $page > ($x +1)){echo'hide';} ?>"><a href="?page=<?php echo $x; ?>&per-page=15&searched=<?php echo $word; ?>" ><?php echo $x; ?></a></li>



             <?php endfor; ?>
             <li class="<?php if($page == $y){echo 'hide';} ?>"><a href="?page=<?php echo $page+1; ?>&per-page=15&searched=<?php echo $word; ?>"><i class="material-icons">chevron_right</i></a></li>
           </ul>
           </div>
   </div>
